...
def runAnalysis(dataDirName):
	...
	ts = time()
	dataPath = "/storage/subhadra/pascal/output/IP3_T10Hz/" + dataDirName
	#dataPath = "/media/nishant/4tb/output/c250/c250/" + dataDirName
	#dataPath = "/home/nishant/output/c250/" + dataDirName

	resultPath = "/storage/subhadra/pascal/results/c_IP3_T10Hz/" + dataDirName
...
if __name__ == "__main__":
	...
	var = os.listdir("/storage/subhadra/pascal/output/IP3_T10Hz/")
